...
| 成员 | 说明 | 类型 | 默认值 |
| --- | --- | --- | --- |
| value | 设置编辑器的值 | string | - |
| ueditorUrl | 设置ueditor(百度编辑器)js文件的地址 | string | 'https://uso.oschina.io/react-ueditor-demo/ueditor.all.js' |
| ueditorConfigUrl | 设置百度编辑器默认config文件地址 | string | 'https://uso.oschina.io/react-ueditor-demo/ueditor.config.js' |
| ueditorHomeUrl | 设置ueditorHomeUrl | string | '' |
| ueditorIframeUrl | 设置ueditorIframeUrl | string | '' |
| editorConfig | 百度编辑器的配置(如果不传则为默认配置) | Object | {} |
...
具体ueditor的使用请移步到https://ueditor.baidu.com/website/index.html
