...
var _Ueditor = __webpack_require__(212);
...
var Page1 = function (_React$Component) {
  ...
  function Page1() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Page1.__proto__ || Object.getPrototypeOf(Page1)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      data: ''
  ...
  _createClass(Page1, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Ueditor2.default, { id: 'content', height: '200' }),
...
var Ueditor = function (_React$Component) {
  ...
  _createClass(Ueditor, [{
    ...
    value: function initEditor() {
      ...
      var ueEditor = UE.getEditor(this.props.id, {/*这里是配置*/});
      var self = this;
...
var BasicExample = function BasicExample() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _page2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/about', component: About })
    )
  );
};

_reactDom2.default.render(_react2.default.createElement(BasicExample, null), document.getElementById('container'));
